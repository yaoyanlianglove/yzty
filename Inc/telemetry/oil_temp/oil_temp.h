...
#define    DATA_WIRE_HIGH    HAL_GPIO_WritePin(OIL_TEMP_GPIO_Port, OIL_TEMP_Pin, GPIO_PIN_SET)       
#define    DATA_WIRE_LOW     HAL_GPIO_WritePin(OIL_TEMP_GPIO_Port, OIL_TEMP_Pin, GPIO_PIN_RESET)
#define    DATA_WIRE_STATUS  HAL_GPIO_ReadPin(OIL_TEMP_GPIO_Port, OIL_TEMP_Pin) 
